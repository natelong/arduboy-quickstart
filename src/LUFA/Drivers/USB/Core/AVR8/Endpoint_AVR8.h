...
static ALWAYS_INLINE ATTR_WARN_UNUSED_RESULT ATTR_CONST uint8_t Endpoint_BytesToEPSizeMask(const uint16_t Bytes) {
    uint8_t  MaskVal    = 0;
 ...
 */
static ALWAYS_INLINE bool Endpoint_ConfigureEndpoint(const uint8_t Number,
                                                     const uint8_t Type,
